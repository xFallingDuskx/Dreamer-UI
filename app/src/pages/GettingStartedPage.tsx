      ...
      <div className='prose prose-lg max-w-none'>
        ...
        <section className='mb-12'>
          <h2 className='text-3xl font-semibold text-foreground mb-6 flex items-center gap-3'>
            <span className='w-8 h-8 bg-gradient-to-r from-primary to-accent rounded-full flex items-center justify-center text-white text-sm font-bold'>
              1
            </span>
            Installation
          </h2>
...
pnpm add @moondreamsdev/dreamer-ui`}
            ...
            <div>
              ...
              <CodeBlock code={`npx dreamer-ui-init`} language='bash' />
              <p className='text-sm text-muted-foreground mt-2'>or, if the above command fails:</p>
              <CodeBlock code={`./node_modules/@moondreamsdev/dreamer-ui/dist/init.js`} language='bash' />
            </div>
...
@source "../node_modules/@moondreamsdev/dreamer-ui/dist/**/*.{js,jsx,ts,tsx}";`}
        ...
        <section className='mb-12'>
          ...
          <p className='text-foreground mb-4'>
            ...
            <code className='bg-muted px-2 py-1 rounded text-sm'>targetClassName</code> and when using{' '}
            <code className='bg-muted px-2 py-1 rounded text-sm'>join()</code>, add the following to your VS Code
            settings.json:
          </p>
          <CodeBlock
            code={`{
  ...
  "tailwindCSS.classFunctions": ["join"]
          ...
          <p className='text-sm text-muted-foreground mt-4'>
            ...
            <code className='bg-muted px-2 py-1 rounded text-sm'>targetClassName</code>,{' '}
            <code className='bg-muted px-2 py-1 rounded text-sm'>containerClassName</code>, etc.
          </p>
        </section>
        ...
        <section className='mb-12'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <div>
              ...
              <p className='text-foreground'>Contributions are welcome! Please read our contributing guidelines.</p>
            </div>
            <div>
