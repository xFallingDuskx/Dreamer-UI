  ...
  return (
    ...
    >
      ...
      <button
        ...
        type="button"
        className={join(
          'flex items-center justify-between w-full text-left bg-transparent border border-border rounded-md transition-colors',
          ...
          {searchable && (
            <div className="p-2 border-b border-border">
              <input
                ...
                className="w-full px-2 py-1 text-sm bg-transparent border border-border rounded focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
