...
export function Copy({ size = 14, color = 'currentColor', className = 'inline', ...props }: IconProps) {
  return (
    <svg
      {...props}
      width={size}
...
export function Download({ size = 14, color = 'currentColor', className = 'inline', ...props }: IconProps) {
  return (
    <svg
      {...props}
      width={size}
...
export function Window({ size = 14, color = 'currentColor', className = 'inline', ...props }: IconProps) {
  return (
    <svg
      {...props}
      width={size}
...
export function Dash({ size = 14, color = 'currentColor', className = 'inline', ...props }: IconProps) {
  return (
    <svg
      {...props}
      width={size}
