        ...
        {showHeader && (
          <thead className={sizeVariant.header} role="rowgroup">
            <tr role="row">
              {selectable && (
                <th 
                  className={join(sizeVariant.headerCell, 'w-12')}
                  role="columnheader"
                ...
                >
                  <input
                    ...
                    ref={(el) => {
                      if (el) el.indeterminate = isPartiallySelected(allRowIds);
                    }}
          ...
          {sortedData.map((item, index) => {
            ...
            return (
              ...
              >
                {selectable && (
                  <td 
                    className={join(sizeVariant.cell, 'w-12')}
                    role="cell"
                  >
                    <input
                      type="checkbox"
