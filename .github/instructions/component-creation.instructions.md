...
1. **Location:** Only create the component files in the `app/` folder, using a component-based architecture (i.e. `app/src/pages/draft/<component-name>/<ComponentName>.ts` and `app/src/<component-name>/index.ts`)
...
6. **Visual Confirmation:** Render the component with its various variants/states in the `app/src/pages/draft/_index.tsx` file.
